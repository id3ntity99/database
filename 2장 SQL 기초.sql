...
INSERT INTO `TblUser` VALUES ('p101', '김춘추', '010-1234-1002', 23, '경남 경주시');
INSERT INTO `TblUser` (`user_id`, `user_name`, `user_age`, `user_addr`) VALUES ('p103', '장보고', 31, '전남 완도군');
INSERT INTO `TblUser` (`user_id`, `user_name`, `user_addr`) VALUES ('p101', '강감찬', '서울시 중구');
INSERT INTO `TblUser` VALUES ('p101', '김유신', '010-1234-1001', 25, null);
